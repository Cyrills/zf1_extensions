...
class Zend_Cache_Backend_Apcu extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
	...
	* Log message
	   */
	  const TAGS_UNSUPPORTED_BY_CLEAN_OF_APCU_BACKEND = 'Core_Cache_Apcu::clean() : tags are unsupported by the Apc backend';
	const TAGS_UNSUPPORTED_BY_SAVE_OF_APCU_BACKEND =  'Core_Cache_Apcu::save() : tags are unsupported by the Apc backend';
